...
namespace Sharkbite2.Irc2
{
	...
	public class UserInfo2 
	{
        ...
        public static readonly UserInfo2 EmptyInstance = new UserInfo2();
		...
		/// <summary> Create a new UserInfo2 and set all its values. </summary>
		public UserInfo2(string nick, string name, string host)  {
		...
		/// <summary> A singleton blank instance of UserInfo2 used when an instance is required
		/// by a method signature but no infomation is available, e.g. the last reply
		/// from a Who request. </summary>
		public static UserInfo2 Empty { get { return EmptyInstance; } }
